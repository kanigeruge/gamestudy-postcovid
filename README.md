...
## Overview
This repository contains the code and synthetic datasets to support verification of the analytic code and transparency. The synthetic dataset was generated using the SDV (Synthetic Data Vault) Python library. Estimates obtained from it do not reproduce the results reported in the paper.
